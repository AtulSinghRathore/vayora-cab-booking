...
export default function FindBookingPage() {
  ...
  return <main className="portal-page">
    <header className="site-header"><Brand /><nav className="desktop-nav"><Link href="/#book">Outstation</Link><Link href="/airport">Airport</Link><Link className="active" href="/booking">Find booking</Link></nav><a className="phone-link" href="tel:+919304591415">+91 93045 91415</a></header>
